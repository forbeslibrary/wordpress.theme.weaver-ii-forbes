 ...
 *
 * Remove the forecolor, underline, and justify buttons from the TinyMCE Editor.
 */
...
/**
 * Add custom CSS to the TinyMCE Editor
 */
add_action( 'init', 'weaveriiforbes_add_editor_styles' );
function weaveriiforbes_add_editor_styles() {
 ...
 *
 * By default Wordpress links images in posts to the image file. We prefer to
 * have no links by deafult.
 */
update_option('image_default_link_type','none');

/**
 * Fix for Weaver II's broken search pagination
 *
 * Weaver II's pagination breaks for search pages if the search query contains
 * spaces. Here we redefine weaverii_get_paginate_archive_page_links with a fix.
 */
...
/**
 * Customize Weaver II's breadcrumbs.
 *
 * Weaver II will sometimes show a pages parent as being a category, for example
 * when using the page with posts template. Here we redefine weaverii_breadcrumb
 * to always show parent page.
 */
