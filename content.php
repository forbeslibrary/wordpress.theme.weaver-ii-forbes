...
/* BEGIN FORBES CUSTOMIZATION. Put page ancestry in header on search pages. */
if (is_search() && 'page' == get_post_type()) {
  $parents = array_reverse(get_post_ancestors(get_the_ID()));
  ?><span class="forbes_search_results_page_path">Home > <?php
  foreach ($parents as $parent) {
    echo get_the_title($parent) . ' > ';
  }
  echo the_title() . '</span>';
}
/* END FORBES CUSTIMIZATION */
?>
